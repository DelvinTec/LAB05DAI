...
/* Calculo de la cantidad de caramelos de obsequio */
$obsequio=$cantidad*2;
            ...
            <div class="col-6 mt-5">
                <div class="card border border-secondary">
                    <div class="card-header bg-primary">
                        <div class="card-title text-black">Resultado 2</div>
                    </div>
                    <div class="card-body">
                        <h2>Datos de: Gaseosa 3 lts
                        </h2>
                        <?php echo '<code>El precio actual es de S/.'.  $precioactual . ' y se ha comprado '.$cantidad.' gaseosas</code>' ?>
                        <br>
                        <?php echo '<strong>+ Nuevo precio: '.$nuevoprecio.'</strong><br>' ?>
                        ...
                        <?php echo '<strong>+ Obsequios: '.$obsequio.' caramelos</strong><br>' ?>
                    </div>
                </div>
            </div>
        </div>

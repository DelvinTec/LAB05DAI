        ...
        <div class="row">
            <div class="col-6 mt-5">
                <div class="card border border-secondary">
                    ...
                    <div class="card-body">
                        <form id="formLogin" action="resultado1.php" method="post">
                            <div class="form-group">
                                <label for="">Nombre y Apellido</label>
                                <input name="nombre" id="nombre" type="text" class="form-control" placeholder="Ingrese su nombre y apellido" required>
                                
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="">Importe total vendido del mes</label>
                                <input type="number" class="form-control" id="importe" name="importe" placeholder="Ingrese su importe total mensual" required>
                                <small id="importeayuda" class="form-text text-muted">Este importe es la suma de todos los productos que ha vendido en todo el mes</small>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="">Cantidad de hijos</label>
                                <input type="number" class="form-control" id="hijos" name="hijos" placeholder="Ingrese la cuantos hijos tiene" required>
                                <small id="hijosayuda" class="form-text text-muted">Hijos e hijas</small>
                            </div>
                            <br>

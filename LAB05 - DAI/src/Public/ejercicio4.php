            ...
            <div class="col-6 mt-5">
                <div class="card border border-secondary">
                    <div class="card-header bg-danger">
                        <div class="card-title text-black">Venta de conos de CD</div>
                    </div>
                    <div class="card-body">
                        <form id="formLogin" action="resultado4.php" method="post">
                            <div class="form-group">
                                <label for="">Precio del cono</label>
                                <input name="precio" id="precio" type="number" class="form-control" placeholder="Ingrese el valor de una unidad del cono de CD" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="">Cantidad comprada</label>
                                <input type="number" class="form-control" id="cantidad" name="cantidad" placeholder="Ingrese la cantidad de conos adquiridos" required>
                            </div>
                            <br>

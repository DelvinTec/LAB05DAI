...
/* Calculo de los dos descuentos */
$primerdescuento=$importecompra*0.05;
$segundodescuento=($importecompra-$primerdescuento)*0.05;

/* Calculo del importe del descuento */
$importedescuento=$primerdescuento+$segundodescuento;

/* Calculo del importe a pagar */
$importepagar=$importecompra-($primerdescuento+$segundodescuento);
            ...
            <div class="col-6 mt-5">
                <div class="card border border-secondary">
                    <div class="card-header bg-danger">
                        <div class="card-title text-black">Resultado 4</div>
                    </div>
                    <div class="card-body">
                        <h2>Datos de: Venta de conos de CD
                        </h2>
                        <?php echo '<code>El precio de un cono es S/.'.  $precio . '  y se ha adquirido '.$cantidad.' de estos</code>' ?>
                        <br>
                        <?php echo '<strong>+ Importe de la compra: '.$importecompra.'</strong><br>' ?>
                        <?php echo '<strong>+ Importe del descuento total: '.$importedescuento.'</strong><br>' ?>
                        <?php echo '<strong>+ Importe a pagar: '.$importepagar.'</strong><br>' ?>
                    </div>
                </div>
            </div>
        </div>
